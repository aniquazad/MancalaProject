...
/**
 * This class is one of the views and the Controller in the MVC pattern for the Mancala application.
 * It holds the actual Mancala board with stones and allows players to interact with the board.
 *
